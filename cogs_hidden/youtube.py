...
async def check_new_video(bot: ryuk, yt_channel_id: str, stored_vid_id: Optional[str] = None) -> Optional[Video]:
    """
...
async def get_playlist_last_vid_id(bot: ryuk, query: str) -> Optional[str]:
...
async def get_yt_channel(bot: ryuk, query: str = None) -> Optional[Channel]:
    """
...
async def get_video_info(bot: ryuk, query: str) -> Optional[Video]:
